'''
Purpose: To solve question 16 of assignment 1 for Machine Learning Foundations on Coursera.
Description: Implement a version of PLA by visiting examples in fixed, pre-determined random
        cycles throughout the algorithm. Please repeat your experiment for 2000 times, each with
