'''
Purpose: To solve question 15 of assignment 1 for Machine Learning Foundations on Coursera.
Description: Implement a version of PLA by visiting examples in the naive cycle 
        using the order of examples in the data set. Please initialize PLA with w=0.
...
Output: The number of updates before the algorithm halts.
'''
