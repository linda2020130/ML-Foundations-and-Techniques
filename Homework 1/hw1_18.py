'''
Purpose: To solve question 18 of assignment 1 for Machine Learning Foundations on Coursera.
Description: Modify the PLA in question 16 to visit examples purely randomly, and then add the 
        'pocket' steps to the algorithm. Use the algorithm on training dataset D to find g, 
        and then use testing dataset to verify g. Run the pocket algorithm with a total of 50 updates
        on D, and verify the performance of w_pocket using the testing dataset. 
